...
Tags: banda, pdf, invoices, packing slips, print, delivery notes, invoice, packing slip, export, email, bulk, automatic
...
Create, print & automatically email PDF invoices & packing slips for Banda orders.

== Description ==

This Banda extension automatically adds a PDF invoice to the order confirmation emails sent out to your customers. Includes a basic template (additional templates are available from [WP Overnight](https://wpovernight.com/downloads/pdf-invoices-packing-slips-premium-templates/)) as well as the possibility to modify/create your own templates. In addition, you can choose to download or print invoices and packing slips from the Banda order admin.

= Main features =
* Automatically attach invoice PDF to Banda emails of your choice
...
* Create/email PDF Proforma Invoices, Credit Notes (for Refunds), email Packing Slips & more with [Banda PDF Invoices & Packing Slips Professional](https://wpovernight.com/downloads/pdf-invoices-packing-slips-professional/)
* Upload all invoices automatically to Dropbox with [Banda PDF Invoices & Packing Slips to Dropbox](https://wpovernight.com/downloads/pdf-invoices-packing-slips-dropbox/)
* Automatically send new orders or packing slips to your printer, as soon as the customer orders! [Banda Automatic Order Printing](https://www.simbahosting.co.uk/s3/product/banda-automatic-order-printing/?affiliates=2) (from our partners at Simba Hosting)
* More advanced & stylish templates with [Banda PDF Invoices & Packing Slips Premium Templates](https://wpovernight.com/downloads/pdf-invoices-packing-slips-premium-templates/)
...
Automatic installation is the easiest option as WordPress handles the file transfers itself and you don't even need to leave your web browser. To do an automatic install of Banda PDF Invoices & Packing Slips, log in to your WordPress admin panel, navigate to the Plugins menu and click Add New.

In the search field type "Banda PDF Invoices & Packing Slips" and click Search Plugins. You can install it by simply clicking Install Now. After clicking that link you will be asked if you're sure you want to install the plugin. Click yes and WordPress will automatically complete the installation. After installation has finished, click the 'activate plugin' link.
...
Make sure to check out [Banda PDF Invoices & Packing Slips documentation](http://docs.wpovernight.com/pdf-invoices-packing-slips/) on our site - it covers most of the questions below (and more!) in more detail!

= How do I create my own custom template? =

Copy the files from `wp-content/plugins/pdf-invoices-packing-slips/templates/pdf/Simple/` to your (child) theme in `wp-content/themes/yourtheme/banda/pdf/yourtemplate` and customize them there. The new template will show up as 'yourtemplate' (the folder name) in the settings panel.

= Where can I find more templates? =

Go to [wpovernight.com](https://wpovernight.com/downloads/pdf-invoices-packing-slips-premium-templates/) to checkout more templates! These include templates with more tax details and product thumbnails. Need a custom templates? Contact us at support@wpovernight.com for more information.

= Can I create/send a proforma invoice or a credit note? =
This is a feature of our Professional extension, which can be found at [wpovernight.com](https://wpovernight.com/downloads/pdf-invoices-packing-slips-professional/)

= Can I contribute to the code? =
You're more than welcome! This plugin is hosted on github, where you can post issues or make pull requests.
https://github.com/wpovernight/pdf-invoices-packing-slips
...
2. Open POEdit
3. File > New from POT
4. Open wpo_wcpdf.pot (from `pdf-invoices-packing-slips/languages/`)
...
`
add_filter('banda_thankyou_order_received_text', 'wpo_wcpdf_thank_you_link', 10, 2);
...
alternatively, you can hook this text to the `banda_thankyou` action, see [this thread](https://wordpress.org/support/topic/suggestion-for-the-faq?replies=5#post-6298810) on the support forum.
...
`
add_filter( 'banda_email_headers', 'mycustom_headers_filter_function', 10, 2);
...
This usually only happens on batch actions. PDF creation is a memory intensive job, especially if it includes several pages with images. Go to Banda > System Status to check your WP Memory Limit. We recommend setting it to 128mb or more.
...
* Tweak: Multisite Banda check optimization
...
* Feature: Banda Order Status & Actions Manager emails compatibility
...
= 1.5.26 =
* Feature: Automatically list all emails registered in Banda
* Feature: Reset invoice number yearly
* Feature: Banda Chained Products compatibility
* Feature: Banda Product Bundles visibility settings taken into account in invoice
* Fix: Disable PDF creation from trashed order_ids
* Tweak: Alert when no orders selected for bulk export (Props to Dartui!)
* Tweak: PDF invoice settings always under Banda menu (also for premium users)
...
= 1.5.23 =
* Fix: Banda Subscriptons 2.0 deprecation notice.
...
= 1.5.17 =
* Feature: Banda Product Bundles compatibility styles
...
* Tweak: Use Banda function for 2.3 discounts
...
* Tweak: Banda Bookings compatibility
...
* Fix: Special characters on item meta (requires Banda 2.3.6)
...
* Fix: Always prefer original order's billing address for refunds (Banda EU VAT Number compatibility)
...
* Tweak: later check for banda active
* Fix: do not try to validate empty settings (Status page settings)
* Translations: Fixed Dutch typo

= 1.5.2 =
* Fix: fatal error when trying to activate with Banda not installed yet.
...
* Feature: Compatibility filter for Banda Subscriptions (prevents duplicate invoice numbers)
...
* Translations: Place your custom translations in wp-content/languages/pdf-invoices-packing-slips/wpo_wcpdf-LOCALE.mo to protect them from being overwritten by plugin updates.
...
* Tweak: changed settings capability requirement to `manage_banda` (was: `manage_options`)
...
= 1.4.6 =
* HOTFIX: Banda 2.2 compatibility fix
