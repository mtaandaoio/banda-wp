...
if ( ! class_exists( 'Banda_PDF_Invoices_Settings' ) ) {
	...
	class Banda_PDF_Invoices_Settings {
		...
		public function settings_page() {
			...
			?>
				<script type="text/javascript">
					jQuery( function( $ ) {
						$("#footer-thankyou").html("If you like <strong>Banda PDF Invoices & Packing Slips</strong> please leave us a <a href='https://wordpress.org/support/view/plugin-reviews/pdf-invoices-packing-slips?rate=5#postform'>★★★★★</a> rating. A huge thank you in advance!");
					});
				</script>
				<div class="wrap">
		...
		public function init_settings() {
			...
			$plugin_template_path = 'wp-content/plugins/pdf-invoices-packing-slips/templates/pdf/Simple';
