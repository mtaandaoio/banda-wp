...
<div class="wrap banda wc_addons_wrap">
	...
	<?php if ( 'Storefront' !== $theme['Name'] && 'featured' !== $current_section ) : ?>
		<div class="storefront">
			...
			<p><?php printf( __( 'Storefront is an intuitive, flexible and %sfree%s WordPress theme offering deep integration with Banda and many of the most popular customer-facing extensions.', 'banda' ), '<strong>', '</strong>' ); ?></p>
			<p>
