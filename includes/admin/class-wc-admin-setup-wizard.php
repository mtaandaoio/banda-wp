...
class WC_Admin_Setup_Wizard {
	...
	private $tweets = array(
		'Someone give me woo-t, I just set up a new store with #WordPress and @Banda!',
		'Someone give me high five, I just set up a new store with #WordPress and @Banda!'
	);
	...
	public function setup_wizard_footer() {
		?>
			<?php if ( 'next_steps' === $this->step ) : ?>
				<a class="wc-return-to-dashboard" href="<?php echo esc_url( admin_url() ); ?>"><?php _e( 'Return to the WordPress Dashboard', 'banda' ); ?></a>
			<?php endif; ?>
			</body>
		</html>
		<?php
	...
	public function wc_setup_introduction() {
		?>
		<h1><?php _e( 'Welcome to the world of Banda!', 'banda' ); ?></h1>
		<p><?php _e( 'Thank you for choosing Banda to power your online store! This quick setup wizard will help you configure the basic settings. <strong>It’s completely optional and shouldn’t take longer than five minutes.</strong>', 'banda' ); ?></p>
		<p><?php _e( 'No time right now? If you don’t want to go through the wizard, you can skip and return to the WordPress dashboard. Come back anytime if you change your mind!', 'banda' ); ?></p>
		<p class="wc-setup-actions step">
			<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>" class="button-primary button button-large button-next"><?php _e( 'Let\'s Go!', 'banda' ); ?></a>
			<a href="<?php echo esc_url( admin_url() ); ?>" class="button button-large"><?php _e( 'Not right now', 'banda' ); ?></a>
		</p>
		<?php
	}
	...
	public function wc_setup_locale() {
		...
		?>
		<h1><?php _e( 'Store Locale Setup', 'banda' ); ?></h1>
		<form method="post">
	...
	protected function get_wizard_payment_gateways() {
		$gateways = array(
			'paypal-braintree' => array(
				...
				'description' => sprintf( __( 'Safe and secure payments using credit cards or your customer\'s PayPal account. %sLearn more about PayPal%s.', 'banda' ), '<a href="https://wordpress.org/plugins/banda-gateway-paypal-powered-by-braintree/" target="_blank">', '</a>' ),
			...
			'paypal-ec' => array(
				...
				'description' => sprintf( __( 'Safe and secure payments using credit cards or your customer\'s PayPal account. %sLearn more about PayPal%s.', 'banda' ), '<a href="https://wordpress.org/plugins/banda-gateway-paypal-express-checkout/" target="_blank">', '</a>' ),
				'class'       => 'featured featured-row-last',
			...
			'stripe' => array(
				...
				'description' => sprintf( __( 'A modern and robust way to accept credit card payments on your store. %sLearn more about Stripe%s.', 'banda' ), '<a href="https://wordpress.org/plugins/banda-gateway-stripe/" target="_blank">', '</a>' ),
