...
class WC_Cart {
	...
	public function __get( $key ) {
		switch ( $key ) {
			...
			return $this->tax;
			case 'discount_total':
				_deprecated_argument( 'WC_Cart->discount_total', '2.3', 'After tax coupons are no longer supported. For more information see: https://banda.wordpress.com/2014/12/upcoming-coupon-changes-in-banda-2-3/' );
			return 0;
		}
	}
