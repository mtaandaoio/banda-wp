...
abstract class SV_WC_API_Base {
	 ...
	 *
	 * Dasherized-Plugin-Name/Plugin-Version (Banda/WC-Version; WordPress/WP-Version)
	 *
	 * @since 2.2.0
	 * @return string
	 */
	protected function get_request_user_agent() {
		...
		return sprintf( '%s/%s (Banda/%s; WordPress/%s)', str_replace( ' ', '-', $this->get_plugin()->get_plugin_name() ), $this->get_plugin()->get_version(), WC_VERSION, $GLOBALS['wp_version'] );
	}
